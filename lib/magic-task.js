...
(function() {
     ...
     */
    MagicTask.prototype.run = function(taskName, callback, data) {
        var runner = new TaskRunner(this._taskList, data);
     ...
     */
    var TaskRunner = function(taskList, taskData) {
    ...
    TaskRunner.prototype.run = function(taskName, callback) {
        var self = this;
        self._finishCallback = function(err, errTaskName, data) {
            self._destroy();
            callback(err, errTaskName, data);
        };
    ...
    TaskRunner.prototype._destroy = function() {
        this._taskList = null;
        this._taskData = null;
    };
